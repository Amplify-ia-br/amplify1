...
type OptimizedImage = string;

interface IndexProps {
  images: {
    forumPalestra: OptimizedImage;
    faculdadeHub: OptimizedImage;
    depoimento: OptimizedImage;
    cases: Array<{ name: string; image: OptimizedImage }>;
  };
}

const trustedCompanies = [
  { name: "Grupo Primo", logo: assetSrc(logoGrupoPrimo) },
  { name: "Amcham", logo: assetSrc(logoAmcham) },
  { name: "Bossa Invest", logo: assetSrc(logoBossaInvest) },
  { name: "DWX", logo: assetSrc(logoDwx) },
  { name: "Gouvêa", logo: assetSrc(logoGouvea) },
  { name: "Tecfil", logo: assetSrc(logoTecfil) },
  { name: "UFG", logo: assetSrc(logoUfg) },
  { name: "CREA-PR", logo: assetSrc(logoCreaPr) },
  { name: "Katsuki", logo: assetSrc(logoKatsuki) },
  { name: "Toccato", logo: assetSrc(logoToccato) },
];
  ...
  return (
    <Layout>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-heading font-bold leading-tight">
              Transforme <span className="gradient-text">dados</span> em <span className="gradient-text">inteligência</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              <Button size="lg" asChild className="glow-cyan text-lg px-8 py-6">
                <a href="https://wa.me/5511918252109?text=Olá! Gostaria de falar com um especialista." target="_blank" rel="noopener noreferrer">
          ...
          <div className="mt-16 space-y-6">
            ...
            <div className="w-full max-w-4xl mx-auto grid grid-cols-3 md:grid-cols-5 gap-4">
              {trustedCompanies.map((company, index) => (
                  ...
                  <img src={company.logo} alt={company.name} width={160} height={40} loading="lazy" decoding="async" className="h-8 md:h-10 w-auto object-contain opacity-70 hover:opacity-100 transition-opacity" />
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center lg:justify-end">
              <img src={images.faculdadeHub} width={1024} height={900} alt="Treinamento presencial de IA" className="rounded-2xl shadow-2xl max-w-full h-auto object-cover" loading="lazy" decoding="async" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-card/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-heading font-bold mb-4">O que <span className="gradient-text">oferecemos</span></h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">Soluções personalizadas em Inteligência Artificial para transformar seu negócio</p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="grid grid-cols-1 gap-6">
              {[
                { icon: Users, title: "Capacitação", description: "Treinamentos práticos e imersivos para sua equipe dominar IA e aplicar no dia a dia corporativo." },
                { icon: Brain, title: "Consultoria e Serviços", description: "Análise estratégica e implementação de soluções de IA personalizadas para acelerar resultados." },
                { icon: Lightbulb, title: "Comunidades", description: "Networking exclusivo com profissionais e líderes que estão transformando seus negócios com IA." },
              ].map((service, index) => (
                <div key={index}>
                  <div className="group p-6 rounded-lg bg-card border border-border hover:border-primary/50 transition-all duration-300 hover:shadow-lg hover:shadow-primary/5">
            ...
            <div className="flex justify-center lg:justify-end">
              <img src={images.forumPalestra} width={1024} height={900} alt="Palestra sobre Inteligência Artificial" className="rounded-2xl shadow-2xl max-w-full h-auto object-cover" loading="lazy" decoding="async" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-heading font-bold mb-4">Alguns dos nossos <span className="gradient-text">cases de sucesso</span></h2>
          </div>

          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {images.cases.map((caseItem, index) => (
              <div key={index}>
                <div className="group relative rounded-2xl overflow-hidden aspect-square">
                  <img src={caseItem.image} width={512} height={512} alt={caseItem.name} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" loading="lazy" decoding="async" />
      ...
      <section className="py-24 bg-card/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-heading font-bold mb-4"><span className="gradient-text">Depoimentos</span></h2>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            <div className="flex justify-center">
              <img src={images.depoimento} width={384} height={384} alt="Guilherme Quandt" className="rounded-2xl shadow-2xl max-w-full h-auto object-cover w-80" loading="lazy" decoding="async" />
            </div>
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            <h2 className="text-3xl md:text-4xl font-heading font-bold">Pronto para <span className="gradient-text">transformar</span> sua empresa?</h2>
