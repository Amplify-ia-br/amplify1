...
import treinamentoPresencial from "@/assets/optimized/treinamento-presencial.webp";
import palestraEvento from "@/assets/palestra-evento.jpeg";
import caseForumNegocios from "@/assets/optimized/case-forum-negocios-capacitacao.webp";
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {[
              { img: assetSrc(caseForumNegocios), title: "Fórum Negócios" },
              { img: assetSrc(caseAssai), title: "Assaí Atacadista" },
            ].map((item, index) => (
              <StaggerItem key={index}>
                <motion.div
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            <FadeInUp>
              <img
                src={assetSrc(treinamentoPresencial)}
