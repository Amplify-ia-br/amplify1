...
const Agenda = ({ fernandoImage }: AgendaProps) => {
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 max-w-4xl mx-auto">
              <Link to="/founders/fernando-godoy" className="shrink-0 group">
                <div className="w-32 h-32 md:w-40 md:h-40 rounded-full overflow-hidden border-4 border-primary/30 group-hover:border-primary transition-colors">
                  <picture>
                    <source type="image/avif" srcSet={fernandoImage.avifSrcSet} sizes={fernandoImage.sizes} />
                    <source type="image/webp" srcSet={fernandoImage.webpSrcSet} sizes={fernandoImage.sizes} />
                    <img
                      src={fernandoImage.fallbackSrc}
                      alt="Fernando Godoy"
                      width={fernandoImage.width}
                      height={fernandoImage.height}
                      loading="lazy"
                      decoding="async"
        ...
        <div className="container mx-auto px-4">
          <FadeInUp>
            <div className="relative rounded-3xl overflow-hidden">
              <img src={assetSrc(palestraEvento)} alt="Palestra Amplify" className="absolute inset-0 w-full h-full object-cover" />
