...
type ServicosConsultoriaProps = {
  heroImage: OptimizedImage;
};

const ServicosConsultoria = ({ heroImage }: ServicosConsultoriaProps) => {
  return (
    <Layout>
      {/* Hero Section */}
      ...
      <section className="relative -mt-8 pb-16">
        <div className="container mx-auto px-4">
          ...
          >
            <picture>
              <source type="image/avif" srcSet={heroImage.avifSrcSet} sizes={heroImage.sizes} />
          ...
          <FadeInUp className="max-w-3xl mx-auto text-center space-y-6">
            ...
            >
              <Button size="lg" asChild className="glow-cyan">
                <a
                  href="https://wa.me/5511918252109?text=Olá! Gostaria de saber mais sobre os serviços de consultoria em IA."
                  target="_blank"
